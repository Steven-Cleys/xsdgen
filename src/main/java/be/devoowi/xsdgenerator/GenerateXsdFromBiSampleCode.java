...
public class GenerateXsdFromBiSampleCode {
    ...
    private static String path = "/Users/cleysst/workspace/fusion_cloud_integration/Workspace_eclipse/UCMFileLoader/src/test/resources/BiSampleCode";
...
//						System.out.println(path);
    ...
    private boolean validateXML(Path file) throws IOException {
        ...
        try {
            ...
            URL xsdURL = getClass().getResource(XSD_RESOURCE);
